...
const countVowelsAndConsonants = (text = "") => {
  ...
  if (!consonantMatches) return console.warn("The text does not contain any consonants.")
  return console.log(
    `${text} has ${vowelMatches.length} vowels (${vowelMatches}) and ${consonantMatches.length} consonants (${consonantMatches}).`
  );
};
